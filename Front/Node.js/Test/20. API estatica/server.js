...
const ordenes = [
    ...
    {'nombre': 'corte de carne', 'cantidad': 2, 'estado': 'En proceso', 'mesa': 4},
    {'nombre': 'sopa', 'cantidad': 1, 'estado': 'pagado', 'mesa': 3},
    {'nombre': 'ensalada', 'cantidad': 1, 'estado': 'pagado', 'mesa': 2},
...
http.createServer((req, res)=>{
    if(req.url == '/'){
       ...
       pedidosEnProceso(res);
        ...
        res.end('No se encontró la solicitud introducida.');
    }
}).listen(3000);
